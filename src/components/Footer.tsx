...
export default function Footer() {
  return (
    <footer className="relative z-10 w-full border-t border-white/5 bg-black py-8 transition-colors duration-300">
        ...
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className="flex items-center gap-1.5 text-xs text-white hover:text-[#ff5e62] transition-colors duration-200"
            >
