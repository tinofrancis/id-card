...
export default function Footer() {
  return (
    <footer className="relative z-10 w-full border-t border-white/5 bg-[#070b12]/90 py-8 backdrop-blur-md transition-colors duration-300">
        ...
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          ...
          <div className="flex flex-wrap items-center gap-6 justify-center sm:justify-end">
            <a
              ...
              className="flex items-center gap-1.5 text-xs text-slate-400 hover:text-[#00F5A0] hover:shadow-[0_0_10px_rgba(0,245,160,0.1)] transition-all duration-200"
            >
