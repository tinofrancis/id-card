  ...
  return (
    ...
    >
      <div className="relative mx-auto flex max-w-7xl h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-5 w-32 sm:h-6 sm:w-36 md:h-7 md:w-44 flex items-center justify-center pointer-events-none">
          <img
            src="/hacker-house-text.png"
            alt="Hacker House Logo"
            className="h-full w-full object-contain filter dark:brightness-100"
          />
        </div>
